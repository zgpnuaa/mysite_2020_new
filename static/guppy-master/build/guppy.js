...
//                 console.log("td");
    ...
    Settings.init = function (symbols) {
       ...
       var board = document.getElementById("777");
       console.log("board");
        console.log(board);
        console.log("Settings.panels[Settings.div_names[i]]");
        console.log(Settings.panels[Settings.div_names[i]]);
        console.log("board");
        board.appendChild(Settings.panels[Settings.div_names[i]]);
...
//            console.log("888");
        if (!this.editor_active && this.engine.doc.is_blank()) {
            ...
            var board = document.getElementById("guppy1");
//            console.log("422");
//            console.log(board);
//            console.log(this.buttons_div);
//            console.log("422");
            board.appendChild(this.buttons_div);
...
//            console.log("522");
    ...
    */
    ...
    Guppy.init = function () {
       ...
       var board = document.getElementById("guppy1");
       board.appendChild(Guppy.raw_input);
       console.log("Guppy.raw_input");
       console.log(Guppy.raw_input);
